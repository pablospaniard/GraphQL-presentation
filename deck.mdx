...
import { GraphiqlComponent, CodeBlock } from './componentns'
import { fetch } from './snippets/operations.js'

export { default as theme } from './theme'

# What is GraphQL? :scream:
...
<CodeBlock style={{ fontSize: 30 }} code={fetch} />
...
A GraphQL subscription is a subscription query string sent to a websocket endpoint. 

And whenever data changes on the backend, new data is pushed over websockets from the server to the client.
